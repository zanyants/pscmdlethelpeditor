...
namespace CmdletHelpEditor.API.BaseClasses {
	public class GeneralDescription : INotifyPropertyChanged {
		...
		[XmlIgnore]
		public String OldInputType { get; set; }
		[XmlIgnore]
		public String OldInputUrl { get; set; }
		[XmlIgnore]
		public String OldInputTypeDescription { get; set; }
		[XmlIgnore]
		public String OldReturnType { get; set; }
		[XmlIgnore]
		public String OldReturnUrl { get; set; }
		[XmlIgnore]
		public String OldReturnTypeDescription { get; set; }
		[XmlIgnore]
